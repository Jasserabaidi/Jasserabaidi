<h1 align="center">🚀 Hi, I'm Jasser Abaidi</h1>
...
💼 **AWS Certified Cloud Practitioner** (and other relevant certifications)  
📍 **Based in** Marburg, Germany 🇩🇪 | **Open to opportunities in** France, Germany, or Remote
...
![Random Forest](https://img.shields.io/badge/Random_Forest-00A86B?style=flat-square&logo=trees&logoColor=white)
...
- ✅ **AI-powered predictions** (Random Forest for battery health with 94% accuracy)
- ✅ **Microservices architecture** (6 Docker containers: Angular, Spring Boot, Python ML, MySQL)
